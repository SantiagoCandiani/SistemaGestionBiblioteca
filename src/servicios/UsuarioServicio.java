...
public class UsuarioServicio {
    ...
    public void ingresarUsuariosPrecargados() {
        ...
        List<Libro> librosPrestadosUsuario01 = Arrays.asList(
                new Libro("Libro1", "Autor1", "ISBN01", "Genero1", 5, true),
                new Libro("Libro2", "Autor2", "ISBN02", "Genero2", 18, true)
        );
        ...
        List<Libro> librosPrestadosUsuario02 = Arrays.asList(
                new Libro("Libro3", "Autor3", "ISBN03", "Genero3", 1, true),
                new Libro("Libro4", "Autor4", "ISBN04", "Genero4", 3, true)
        );
        ...
        List<Libro> librosPrestadosUsuario03 = Arrays.asList(
                new Libro("Libro5", "Autor5", "ISBN05", "Genero5", 10, true),
                new Libro("Libro6", "Autor6", "ISBN06", "Genero6", 6, true)
        );
        ...
        List<Libro> librosPrestadosUsuario04 = Arrays.asList(
                new Libro("Libro7", "Autor7", "ISBN07", "Genero7", 2, true),
                new Libro("Libro8", "Autor8", "ISBN08", "Genero8", 4, true)
        );
        ...
        List<Libro> librosPrestadosUsuario05 = Arrays.asList(
                new Libro("Libro9", "Autor9", "ISBN09", "Genero9", 7, true),
                new Libro("Libro10", "Autor10", "ISBN10", "Genero10", 2, true)
        );
        ...
        List<Libro> librosPrestadosUsuario06 = Arrays.asList(
                new Libro("Libro11", "Autor11", "ISBN11", "Genero11", 3, true),
                new Libro("Libro12", "Autor12", "ISBN12", "Genero12", 8, true)
        );
        ...
        List<Libro> librosPrestadosUsuario07 = Arrays.asList(
                new Libro("Libro13", "Autor13", "ISBN13", "Genero13", 6, true),
                new Libro("Libro14", "Autor14", "ISBN14", "Genero14", 12, true)
        );
        ...
        List<Libro> librosPrestadosUsuario08 = Arrays.asList(
                new Libro("Libro15", "Autor15", "ISBN15", "Genero15", 9, true),
                new Libro("Libro16", "Autor16", "ISBN16", "Genero16", 5, true)
        );
        ...
        List<Libro> librosPrestadosUsuario09 = Arrays.asList(
                new Libro("Libro17", "Autor17", "ISBN17", "Genero17", 4, true),
                new Libro("Libro18", "Autor18", "ISBN18", "Genero18", 6, true)
        );
        ...
        List<Libro> librosPrestadosUsuario10 = Arrays.asList(
                new Libro("Libro19", "Autor19", "ISBN19", "Genero19", 11, true),
                new Libro("Libro20", "Autor20", "ISBN20", "Genero20", 7, true)
        );
